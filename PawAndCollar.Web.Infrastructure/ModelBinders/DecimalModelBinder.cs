...
namespace PawAndCollar.Web.Infrastructure.ModelBinders
{
		...
		public Task BindModelAsync(ModelBindingContext bindingContext)
		{
			...
			if(valueResult != ValueProviderResult.None && string.IsNullOrWhiteSpace(valueResult.FirstValue))
			{
				...
				try
				{
					...
					formDecValue = formDecValue.Replace(",", CultureInfo.InvariantCulture.NumberFormat.NumberDecimalSeparator);
					formDecValue = formDecValue.Replace(".", CultureInfo.InvariantCulture.NumberFormat.NumberDecimalSeparator);
